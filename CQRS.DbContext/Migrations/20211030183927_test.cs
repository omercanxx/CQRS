    ...
    public partial class test : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Order_Campaigns", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "text", nullable: true),
                    Price = table.Column<decimal>(type: "numeric", nullable: false),
                    User_ProductId = table.Column<Guid>(type: "uuid", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_User_ProductItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_User_ProductItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_User_ProductItems_User_Products_User_ProductId",
                        column: x => x.User_ProductId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_ProductItems_ProductId",
                table: "User_ProductItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_User_ProductItems_User_ProductId",
                table: "User_ProductItems",
                column: "User_ProductId");
